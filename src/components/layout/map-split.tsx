 ...
 *
 * The options column is `relative` and `overflow-hidden`, so BottomSheet /
 * DockedPanel / Dialog (which position against the nearest positioned ancestor)
 * stay contained inside it.
 */
