  ...
  persist(
    (set, get) => ({
      ...
      setSelectedVehicle: (selectedVehicleTypeId) => {
        ...
        if (est && (est.vehicleTypeCode === "TUK" || (est as any).vehicleTypeCode === "TUKTUK" || est.available !== false)) {
          set({ selectedVehicleTypeId });
        }
      },
      ...
      async createDraft(riderId) {
        ...
        try {
          ...
          const selected =
            estimates.find((e) => e.vehicleTypeId === preferred && (e.vehicleTypeCode === "TUK" || (e as any).vehicleTypeCode === "TUKTUK"))?.vehicleTypeId ??
            estimates.find((e) => e.vehicleTypeCode === "TUK" || (e as any).vehicleTypeCode === "TUKTUK")?.vehicleTypeId ??
            estimates.find((e) => e.available)?.vehicleTypeId ??
            estimates[0]?.vehicleTypeId ??
            null;
