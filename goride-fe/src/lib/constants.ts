...
export function profileForRole(role: Role) {
  return role === "Admin" ? ROUTES.admin.profile : role === "Driver" ? ROUTES.driver.profile : ROUTES.rider.profile;
}
...
export const VEHICLE_TYPES: { code: VehicleTypeCode; name: string; seats: number }[] = [
...
export const DEMO_ACCOUNTS = [
  { role: "Rider" as const, email: "rider@goride.lk", name: "Nimali Perera", hint: "Book & track a ride" },
  { role: "Driver" as const, email: "driver@goride.lk", name: "Kasun Fernando", hint: "Go online, accept rides" },
  { role: "Admin" as const, email: "admin@goride.lk", name: "Shageeshan T", hint: "Verify drivers, SOS, audit" },
];
